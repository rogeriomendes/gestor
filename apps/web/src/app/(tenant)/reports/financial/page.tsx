...
export default function FinancialReportPage() {
  const report = getReportById("financial");
  ...
  const accountsReceivableQuery = useQuery({
    ...trpc.tenant.reports.accountsReceivable.queryOptions({
      status: "all",
  ...
  const financialSummaryQuery = useQuery({
    ...trpc.tenant.reports.financialSummary.queryOptions({
      initialDate: filters.initialDate,
      finalDate: filters.finalDate,
      companyId,
    }),
  ...
  const isLoading =
    accountsReceivableQuery.isLoading || financialSummaryQuery.isLoading;
  const isError =
