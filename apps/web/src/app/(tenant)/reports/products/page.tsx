...
export default function ProductsReportPage() {
  const report = getReportById("products");
  ...
  const { data, isLoading, isError } = useQuery({
    ...trpc.tenant.reports.topProducts.queryOptions({
  ...
  const getExportData = () => {
    return report.getExportData({ topProducts: data });
  };
