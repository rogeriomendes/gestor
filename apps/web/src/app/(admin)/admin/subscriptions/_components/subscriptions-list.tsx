...
export function SubscriptionsList({
    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Lista de todas as assinaturas de clientes
          </CardDescription>
        </CardHeader>
        <CardContent>
  ...
  if (subscriptions.length === 0) {
    return (
      <Card>
        <CardHeader>
          <CardTitle>0 assinaturas</CardTitle>
          <CardDescription>
            Lista de todas as assinaturas de clientes
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Empty>
            <EmptyHeader>
              ...
              <EmptyDescription>
                Não há assinaturas cadastradas. Você pode criar uma assinatura
                para um cliente existente ou criar um novo cliente (que já
                receberá um trial automaticamente).
              </EmptyDescription>
            </EmptyHeader>
            <EmptyContent>
